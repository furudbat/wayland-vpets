...
[[nodiscard]] created_result_t<ms_agent_sprite_sheet_t>
...
[[nodiscard]] created_result_t<ms_agent_sprite_sheet_t> load_ms_agent_sprite_sheet(const animation_context_t& ctx,
                                                                                   int index);
}  // namespace bongocat::animation
