...
BONGOCAT_NODISCARD created_result_t<AllocatedMemory<wayland_session_t>> create(animation::animation_session_t& anim,
...
BONGOCAT_NODISCARD bongocat_error_t run(wayland_session_t& ctx, volatile sig_atomic_t& running, int signal_fd,
