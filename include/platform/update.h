...
namespace bongocat::platform::update {
    ...
    BONGOCAT_NODISCARD bongocat_error_t start(update_context_t& input, animation::animation_session_t& trigger_ctx, const config::config_t& config, CondVariable& configs_reloaded_cond, atomic_uint64_t& config_generation);
    BONGOCAT_NODISCARD bongocat_error_t restart(update_context_t& input, animation::animation_session_t& trigger_ctx, const config::config_t& config, CondVariable& configs_reloaded_cond, atomic_uint64_t& config_generation);
