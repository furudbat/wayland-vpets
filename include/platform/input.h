...
BONGOCAT_NODISCARD bongocat_error_t start(input_context_t& input, animation::animation_session_t& trigger_ctx,
...
BONGOCAT_NODISCARD bongocat_error_t restart(input_context_t& input, animation::animation_session_t& trigger_ctx,
                                            const config::config_t& config, CondVariable& configs_reloaded_cond,
                                            atomic_uint64_t& config_generation);
