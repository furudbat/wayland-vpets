...
#embed "../../../assets/bongo-cat-both-up.png"
    ...
    inline static constexpr size_t bongo_cat_both_up_png_size = sizeof(bongo_cat_both_up_png);

    inline static constexpr unsigned char bongo_cat_left_down_png[] = {
#embed "../../../assets/bongo-cat-left-down.png"
    };
    inline static constexpr size_t bongo_cat_left_down_png_size = sizeof(bongo_cat_left_down_png);

    inline static constexpr unsigned char bongo_cat_right_down_png[] = {
#embed "../../../assets/bongo-cat-right-down.png"
    };
    inline static constexpr size_t bongo_cat_right_down_png_size = sizeof(bongo_cat_right_down_png);

    inline static constexpr unsigned char bongo_cat_both_down_png[] = {
#embed "../../../assets/bongo-cat-both-down.png"
    };
    inline static constexpr size_t bongo_cat_both_down_png_size = sizeof(bongo_cat_both_down_png);

    inline static constexpr size_t BONGOCAT_ANIM_INDEX = 0;
}

#endif // EMBEDDED_ASSETS_BINGOCAT_HPP
