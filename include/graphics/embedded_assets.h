...
#define DIGIMON_ANIMATIONS_COUNT (DM_ANIM_COUNT+DM20_ANIM_COUNT+DMC_ANIM_COUNT+DMX_ANIM_COUNT+PEN20_ANIM_COUNT)
#else
#define DIGIMON_ANIMATIONS_COUNT 0
#endif
#define ANIMS_COUNT (1+DIGIMON_ANIMATIONS_COUNT)
