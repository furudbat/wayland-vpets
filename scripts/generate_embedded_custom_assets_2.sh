...
for FILE in "$INPUT_DIR"/*.png; do
    ...
    echo "    inline static constexpr size_t ${MACRO_PREFIX}_FQID_LEN CONFIG_STRING2_SECTION = sizeof(${MACRO_PREFIX}_FQID_ARR)-1;" >> "$CPP_HEADER_OUT"
    ...
    echo "    inline static constexpr size_t ${MACRO_PREFIX}_ID_LEN CONFIG_STRING2_SECTION = sizeof(${MACRO_PREFIX}_ID)-1;" >> "$CPP_HEADER_OUT"
    ...
    echo "    inline static constexpr size_t ${MACRO_PREFIX}_NAME_LEN CONFIG_STRING2_SECTION = sizeof(${MACRO_PREFIX}_NAME_ARR)-1;" >> "$CPP_HEADER_OUT"
    ...
    echo "    inline static constexpr size_t ${MACRO_PREFIX}_FQNAME_LEN CONFIG_STRING2_SECTION = sizeof(${MACRO_PREFIX}_FQNAME_ARR)-1;" >> "$CPP_HEADER_OUT"
    ...
    echo "    inline static constexpr custom_animation_settings_t ${MACRO_PREFIX}_SPRITE_SHEET_SETTINGS ASSETS_DATA2_SECTION = {" >> "$CPP_HEADER_OUT"
    ...
    echo "    inline static constexpr int ${MACRO_PREFIX}_SPRITE_SHEET_MAX_COLS ASSETS_DATA_SECTION = $COLS;" >> "$CPP_HEADER_OUT"
...
echo "    static const custom_animation_settings_t ${ASSETS_PREFIX_LOWER}_settings_table[] ASSETS_TABLE2_SECTION = {" >> "$CPP_SOURCE_GET_SPRITE_OUT_2"
...
echo "    static const assets::custom_animation_settings_t ${ASSETS_PREFIX_LOWER}_settings_table[] ASSETS_TABLE2_SECTION = {" >> "$CPP_SOURCE_LOAD_SPRITE_OUT"
