...
./scripts/generate_embedded_assets.sh assets/dmc assets/input/dmc-fixed include/graphics/embedded_assets/dmc_images.h src/graphics/embedded_assets/dmc_images.c include/graphics/embedded_assets/dmc.hpp --frame-size 128
