...
for FILE in "$INPUT_DIR"/*.png; do
    ...
    if [[ -n $ALT ]]; then
      ...
      OUTPUT_FILE_5_ALT_ANIMATIONS="${OUTPUT_FILE_5_ALT_ANIMATIONS}    inline static constexpr const char* ALT_${MACRO_PREFIX}_FQID CONFIG_STRING2_SECTION = ALT_${MACRO_PREFIX}_FQID_ARR;\n"
      ...
      OUTPUT_FILE_5_ALT_ANIMATIONS="${OUTPUT_FILE_5_ALT_ANIMATIONS}    inline static constexpr const char* ALT_${MACRO_PREFIX}_FQNAME CONFIG_STRING2_SECTION = ALT_${MACRO_PREFIX}_FQNAME_ARR;\n"
...
echo "    static const config_custom_animation_entry_t ${ASSETS_PREFIX_LOWER}_animation_table[] CONFIG_TABLE_SECTION = {" >> "$OUTPUT_FILE_5"
echo -e "        ${OUTPUT_FILE_5_ANIMATION_TABLE}" >> "$OUTPUT_FILE_5"
echo '    };' >> "$OUTPUT_FILE_5"
if [[ -n $ALT ]]; then
  echo -e "${OUTPUT_FILE_5_ALT_ANIMATIONS}\n" >> "$OUTPUT_FILE_5"
  echo "    static const config_custom_animation_entry_t ${ASSETS_PREFIX_LOWER}_alt_animation_table[] CONFIG_TABLE_SECTION = {" >> "$OUTPUT_FILE_5"
