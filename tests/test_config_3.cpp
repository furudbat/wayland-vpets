...
# random: random animation_index (0 = off, 1 = on)
# animation_name still needs to be set to determine the animation set option (bongocat, dm or MS agent)
random=0
