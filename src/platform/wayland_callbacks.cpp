...
for (type *pos = reinterpret_cast<type*>((array)->data); \
    ...
    void handle_xdg_output_logical_size(void *data, [[maybe_unused]] zxdg_output_v1 *xdg_output,
    ...
    void handle_xdg_output_description(void *data, [[maybe_unused]] zxdg_output_v1 *xdg_output, [[maybe_unused]] const char *description) {
        if (!data) {
            BONGOCAT_LOG_VERBOSE("Handler called with null data (ignored)");
            return;
        }
    ...
    void fs_handle_toplevel_state(void *data, [[maybe_unused]] zwlr_foreign_toplevel_handle_v1 *handle,
                                         wl_array *state) {
        if (!data) {
            BONGOCAT_LOG_VERBOSE("Handler called with null data (ignored)");
            return;
    ...
    void fs_handle_title(void *data, [[maybe_unused]] zwlr_foreign_toplevel_handle_v1 *handle, [[maybe_unused]] const char *title) {
        if (!data) {
            BONGOCAT_LOG_VERBOSE("Handler called with null data (ignored)");
            return;
        }
    ...
    void fs_handle_app_id(void *data, [[maybe_unused]] zwlr_foreign_toplevel_handle_v1 *handle, [[maybe_unused]] const char *app_id) {
        if (!data) {
            BONGOCAT_LOG_VERBOSE("Handler called with null data (ignored)");
            return;
        }
    ...
    void fs_handle_output_enter(void *data, [[maybe_unused]] zwlr_foreign_toplevel_handle_v1 *handle, [[maybe_unused]] wl_output *output) {
        if (!data) {
            BONGOCAT_LOG_VERBOSE("Handler called with null data (ignored)");
            return;
        }
    ...
    void fs_handle_output_leave(void *data, [[maybe_unused]] zwlr_foreign_toplevel_handle_v1 *handle, [[maybe_unused]] wl_output *output) {
        if (!data) {
            BONGOCAT_LOG_VERBOSE("Handler called with null data (ignored)");
            return;
        }
    ...
    void fs_handle_parent(void *data, [[maybe_unused]] zwlr_foreign_toplevel_handle_v1 *handle, [[maybe_unused]] zwlr_foreign_toplevel_handle_v1 *parent) {
        if (!data) {
            BONGOCAT_LOG_VERBOSE("Handler called with null data (ignored)");
            return;
        }
    ...
    void registry_global(void *data , wl_registry *reg,
