...
namespace bongocat::animation {
    ...
    */
    ...
    [[maybe_unused]] static bongocat_error_t anim_load_sprite_sheet(const config::config_t& config, ms_pet_sprite_sheet_t& anim, const assets::embedded_image_t& sprite_sheet_image, int sprite_sheet_cols, int sprite_sheet_rows) {
        if (sprite_sheet_cols < 0 || sprite_sheet_rows < 0) {
            return bongocat_error_t::BONGOCAT_ERROR_INVALID_PARAM;
        }
