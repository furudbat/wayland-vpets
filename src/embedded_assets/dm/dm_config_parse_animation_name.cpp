...
namespace bongocat::assets {
    ...
    static const config_animation_names_entry_t dm_animation_names_table[] = {
        ...
        { DM_CORONAMON_NAME, DM_CORONAMON_NAME_LEN, DM_CORONAMON_ID, DM_CORONAMON_ID_LEN, DM_CORONAMON_FQID, DM_CORONAMON_FQID_LEN, DM_CORONAMON_FQNAME, DM_CORONAMON_FQNAME_LEN },
    ...
    static void unload_config_parse_animation_names_dm() {
        for (const auto& entry : dm_animation_names_table) {
    ...
    int config_parse_animation_name_dm(config::config_t& config, const char *value) {
        ...
        unload_config_parse_animation_names_dm();
        return ret;
    }
}
