...
namespace bongocat::assets {
    embedded_image_t get_pen_sprite_sheet(size_t index) {
        switch (index) {
            ...
            case PEN_ANDROMON_ANIM_INDEX: return {pen_andromon_png, pen_andromon_png_size, "andromon"};
            ...
            case PEN_BAKEMON_ANIM_INDEX: return {pen_bakemon_png, pen_bakemon_png_size, "bakemon"};
            ...
            case PEN_BIRDRAMON_ANIM_INDEX: return {pen_birdramon_png, pen_birdramon_png_size, "birdramon"};
            ...
            case PEN_COELAMON_ANIM_INDEX: return {pen_coelamon_png, pen_coelamon_png_size, "coelamon"};
            ...
            case PEN_DEVIMON_ANIM_INDEX: return {pen_devimon_png, pen_devimon_png_size, "devimon"};
            ...
            case PEN_GARURUMON_ANIM_INDEX: return {pen_garurumon_png, pen_garurumon_png_size, "garurumon"};
            ...
            case PEN_GREYMON_ANIM_INDEX: return {pen_greymon_png, pen_greymon_png_size, "greymon"};
            ...
            case PEN_HANGYOMON_ANIM_INDEX: return {pen_hangyomon_png, pen_hangyomon_png_size, "hangyomon"};
            case PEN_HANUMON_ANIM_INDEX: return {pen_hanumon_png, pen_hanumon_png_size, "hanumon"};
            case PEN_HERAKLE_KABUTERIMON_ANIM_INDEX: return {pen_herakle_kabuterimon_png, pen_herakle_kabuterimon_png_size, "herakle_kabuterimon"};
            ...
            case PEN_KABUTERIMON_ANIM_INDEX: return {pen_kabuterimon_png, pen_kabuterimon_png_size, "kabuterimon"};
            ...
            case PEN_KUWAGAMON_ANIM_INDEX: return {pen_kuwagamon_png, pen_kuwagamon_png_size, "kuwagamon"};
            ...
            case PEN_MEGADRAMON_ANIM_INDEX: return {pen_megadramon_png, pen_megadramon_png_size, "megadramon"};
            case PEN_MEGA_SEADRAMON_ANIM_INDEX: return {pen_mega_seadramon_png, pen_mega_seadramon_png_size, "mega_seadramon"};
            case PEN_MERAMON_ANIM_INDEX: return {pen_meramon_png, pen_meramon_png_size, "meramon"};
            case PEN_METAL_ETEMON_ANIM_INDEX: return {pen_metal_etemon_png, pen_metal_etemon_png_size, "metal_etemon"};
            case PEN_METAL_GARURUMON_ANIM_INDEX: return {pen_metal_garurumon_png, pen_metal_garurumon_png_size, "metal_garurumon"};
            case PEN_METAL_GREYMON_ANIM_INDEX: return {pen_metal_greymon_png, pen_metal_greymon_png_size, "metal_greymon"};
            case PEN_METAL_MAMEMON_ANIM_INDEX: return {pen_metal_mamemon_png, pen_metal_mamemon_png_size, "metal_mamemon"};
            ...
            case PEN_MONOCHROMON_ANIM_INDEX: return {pen_monochromon_png, pen_monochromon_png_size, "monochromon"};
            case PEN_MUGENDRAMON_ANIM_INDEX: return {pen_mugendramon_png, pen_mugendramon_png_size, "mugendramon"};
            ...
            case PEN_OMEGAMON_ANIM_INDEX: return {pen_omegamon_png, pen_omegamon_png_size, "omegamon"};
            case PEN_OTAMAMON_ANIM_INDEX: return {pen_otamamon_png, pen_otamamon_png_size, "otamamon"};
            case PEN_PALMON_ANIM_INDEX: return {pen_palmon_png, pen_palmon_png_size, "palmon"};
            case PEN_PETI_MERAMON_ANIM_INDEX: return {pen_peti_meramon_png, pen_peti_meramon_png_size, "peti_meramon"};
            case PEN_PICCOLOMON_ANIM_INDEX: return {pen_piccolomon_png, pen_piccolomon_png_size, "piccolomon"};
            ...
            case PEN_PINOCHIMON_ANIM_INDEX: return {pen_pinochimon_png, pen_pinochimon_png_size, "pinochimon"};
            case PEN_PIYOMON_ANIM_INDEX: return {pen_piyomon_png, pen_piyomon_png_size, "piyomon"};
            ...
            case PEN_RUKAMON_ANIM_INDEX: return {pen_rukamon_png, pen_rukamon_png_size, "rukamon"};
            case PEN_SABER_LEOMON_ANIM_INDEX: return {pen_saber_leomon_png, pen_saber_leomon_png_size, "saber_leomon"};
            case PEN_SEADRAMON_ANIM_INDEX: return {pen_seadramon_png, pen_seadramon_png_size, "seadramon"};
            case PEN_SHAKOMON_ANIM_INDEX: return {pen_shakomon_png, pen_shakomon_png_size, "shakomon"};
            case PEN_SKULL_MAMMON_ANIM_INDEX: return {pen_skull_mammon_png, pen_skull_mammon_png_size, "skull_mammon"};
            ...
            case PEN_VAMDEMON_ANIM_INDEX: return {pen_vamdemon_png, pen_vamdemon_png_size, "vamdemon"};
            ...
            case PEN_WAR_GREYMON_ANIM_INDEX: return {pen_war_greymon_png, pen_war_greymon_png_size, "war_greymon"};
            case PEN_WARU_MONZAEMON_ANIM_INDEX: return {pen_waru_monzaemon_png, pen_waru_monzaemon_png_size, "waru_monzaemon"};
            case PEN_WARU_MOZAEMON_ANIM_INDEX: return {pen_waru_mozaemon_png, pen_waru_mozaemon_png_size, "waru_mozaemon"};
            case PEN_WERE_GARURUMON_ANIM_INDEX: return {pen_were_garurumon_png, pen_were_garurumon_png_size, "were_garurumon"};
            case PEN_WHAMON_ANIM_INDEX: return {pen_whamon_png, pen_whamon_png_size, "whamon"};
            ...
            case PEN_ZUDOMON_ANIM_INDEX: return {pen_zudomon_png, pen_zudomon_png_size, "zudomon"};
