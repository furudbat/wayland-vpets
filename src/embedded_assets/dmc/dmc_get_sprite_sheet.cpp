...
namespace bongocat::assets {
    embedded_image_t get_dmc_sprite_sheet(size_t index) {
        switch (index) {
            ...
            case DMC_BANCHO_LEOMON_ANIM_INDEX: return {dmc_bancho_leomon_png, dmc_bancho_leomon_png_size, "bancho_leomon"};
            ...
            case DMC_BLOOM_LORDMON_ANIM_INDEX: return {dmc_bloom_lordmon_png, dmc_bloom_lordmon_png_size, "bloom_lordmon"};
            ...
            case DMC_CHAOSDRAMON_ANIM_INDEX: return {dmc_chaosdramon_png, dmc_chaosdramon_png_size, "chaosdramon"};
            case DMC_CHAOSMON_ANIM_INDEX: return {dmc_chaosmon_png, dmc_chaosmon_png_size, "chaosmon"};
            case DMC_CHIMAIRAMON_ANIM_INDEX: return {dmc_chimairamon_png, dmc_chimairamon_png_size, "chimairamon"};
            ...
            case DMC_DARKDRAMON_ANIM_INDEX: return {dmc_darkdramon_png, dmc_darkdramon_png_size, "darkdramon"};
            ...
            case DMC_EBEMON_ANIM_INDEX: return {dmc_ebemon_png, dmc_ebemon_png_size, "ebemon"};
            ...
            case DMC_GAIOUMON_ANIM_INDEX: return {dmc_gaioumon_png, dmc_gaioumon_png_size, "gaioumon"};
            case DMC_GANKOOMON_ANIM_INDEX: return {dmc_gankoomon_png, dmc_gankoomon_png_size, "gankoomon"};
            ...
            case DMC_GOKUMON_ANIM_INDEX: return {dmc_gokumon_png, dmc_gokumon_png_size, "gokumon"};
            ...
            case DMC_MILLENNIUMON_ANIM_INDEX: return {dmc_millenniumon_png, dmc_millenniumon_png_size, "millenniumon"};
            case DMC_MOJYAMON_ANIM_INDEX: return {dmc_mojyamon_png, dmc_mojyamon_png_size, "mojyamon"};
            ...
            case DMC_MONZAEMON_ANIM_INDEX: return {dmc_monzaemon_png, dmc_monzaemon_png_size, "monzaemon"};
            ...
            case DMC_OGREMON_ANIM_INDEX: return {dmc_ogremon_png, dmc_ogremon_png_size, "ogremon"};
            ...
            case DMC_TUNOMON_ANIM_INDEX: return {dmc_tunomon_png, dmc_tunomon_png_size, "tunomon"};
