...
static bongocat_error_t system_initialize_components() {
    ...
    bongocat_error_t result = wayland_init(g_wayland_listeners_ctx, g_wayland_ctx, g_animation_ctx,
...
int main(int argc, char *argv[]) {
    ...
    bongocat_error_t result = load_config(g_config, args.config_file, g_overwrite_parameters);
    if (result != bongocat_error_t::BONGOCAT_SUCCESS) {
