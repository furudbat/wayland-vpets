...
namespace bongocat::animation {
    BONGOCAT_NODISCARD static created_result_t<ms_agent_sprite_sheet_t> load_ms_agent_sprite_sheet_from_memory(const uint8_t* sprite_data, size_t sprite_data_size,
