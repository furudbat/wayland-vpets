...
namespace bongocat::animation {
    ...
    BONGOCAT_NODISCARD static created_result_t<Image> load_image_pngle(const unsigned char *data, size_t size, int desired_channels) {
        Image ret;
    ...
    BONGOCAT_NODISCARD static created_result_t<Image> load_image_stb_image(const unsigned char *data, size_t size, int desired_channels) {
        Image ret;
        assert(size <= INT_MAX);
